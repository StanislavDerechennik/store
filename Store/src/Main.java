...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        User user1 = new User("qwerty", "qwerty", new Basket());
        ...
        FileInputStream fileInputStream = new FileInputStream("C:\\Users\\Pelmenoid\\IdeaProjects\\Store\\src\\save\\save.ser");
        ...
        while (true) {
            ...
            System.out.println("3. Просмотр списка каталогов товаров");
                            ...
                            while (true) {
                                ...
                                if (isChosen) {
                                    if (!userLogined.getLogin().isEmpty()) {
                                        ...
                                        System.out.println("Для добавления товара в корзину пройдите аутентификацию или регистрацию!");
                                    }
                                }
                            }
                        }
        ...
        FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\Pelmenoid\\IdeaProjects\\Store\\src\\save\\save.ser");
